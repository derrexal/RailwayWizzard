namespace RailwayWizzard.Rzd.DataEngine.Core
{
    ...
    [Obsolete]
    public class DestinationStationInfoFull
    {
    ...
    [Obsolete]
    public class FinalStationInfoFull
    {
        public string StationName { get; set; } = null!;
        public string StationCode { get; set; } = null!;
        public string CnsiCode { get; set; } = null!;
    ...
    public class RootFull
    {
        ...
        public DestinationStationInfoFull DestinationStationInfo { get; set; } = null!;
    ...
    public class TrainFull
    {
        ...
        public string DestinationStationCode { get; set; } = null!;
        public DestinationStationInfoFull DestinationStationInfo { get; set; } = null!;
        public FinalStationInfoFull FinalStationInfo { get; set; } = null!;
